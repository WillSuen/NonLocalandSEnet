...
import mxnet as mx
import symbol.symbol_seresnet as seresnet
...
def main():
    ...
    model_prefix = cfg.model_path + "seresnet-{}-{}-{}-{}".format(cfg.dataset.data_type, cfg.network.depth, kv.rank, 2)
    ...
    model = mx.model.FeedForward(
        ...
        num_epoch           = 200 if cfg.dataset.data_type in ["cifar10", "cifar100"] else 200,
